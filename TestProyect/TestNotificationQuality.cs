...
namespace TestProyect
{
    public class TestNotificationQuality
    {
        ...
        [Test]
        public void sendMailNotificationQualityEstandarTest()
        {
            //Arrange
            string[] qualityEmail = new string[2];
            qualityEmail[0] = "omar.andreas.sotomayor@gmail.com";
            ...
            string emailBody = emailBodyForQualityEstandard();
            //Action
            Notification notification = new Notification();
            notification.sendMailNotification(qualityEmail, emailBody, emailSubject);
            //Assert
            Assert.AreEqual(emailSubject, "Notificacion de devolucion de Estándar");
        }

        private string emailBodyForQualityEstandard()
        {
            DateForReport dates = new DateForReport();
            string body;
            ...
            string estandards = "EST-TEST, EST-INO";
