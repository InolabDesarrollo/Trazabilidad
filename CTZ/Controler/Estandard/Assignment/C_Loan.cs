...
{
    public abstract class C_Loan : C_Estandard_Assignment
    {
        public void registerDeliveryStandar(Estandard_Assignment assignment, List<string> estEstandards)
        {
            ...
            this.updateStatusStandar(assignment, estEstandards);
        ...
        protected abstract void updateStatusStandar(Estandard_Assignment assignment, List<string> estEstandards);
